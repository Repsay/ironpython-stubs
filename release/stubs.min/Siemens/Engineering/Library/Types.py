...
"""
 ...
 Versions=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class LibraryTypeInstanceInfo(object,IEngineeringObject,IEngineeringCompositionOrObject,IEngineeringInstance,IEngineeringService,IInternalObjectAccess,IInternalInstanceAccess,IInternalBaseAccess,IEquatable[object]):
 ...
 def __str__(self,*args):
  pass
 LibraryTypeInstance=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LibraryTypeVersion=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Connected version
...
"""
 ...
 Dependencies=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Dependents=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MasterCopiesContainingInstances=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TypeObject=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MessageParts=property(lambda self: object(),lambda self,v: None,lambda self: None)
