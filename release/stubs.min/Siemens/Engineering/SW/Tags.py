...
class PlcConstant(object,IEngineeringObject,IEngineeringCompositionOrObject,IEngineeringInstance,IMasterCopySource,IInternalObjectAccess,IInternalInstanceAccess,IInternalBaseAccess,IEquatable[object]):
 ...
 def __str__(self,*args):
  pass
 DataTypeName=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ExternalAccessible=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Internal use only
...
"""
 ...
 ExternalVisible=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ExternalWritable=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LogicalAddress=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ModifiedTimeStamp=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 SystemConstants=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 UserConstants=property(lambda self: object(),lambda self,v: None,lambda self: None)
