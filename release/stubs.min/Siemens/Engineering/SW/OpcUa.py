...
"""
 ...
 ServerInterfaceGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class OpcUaProvider(object,IEngineeringObject,IEngineeringCompositionOrObject,IEngineeringInstance,IEngineeringService,IInternalObjectAccess,IInternalInstanceAccess,IInternalBaseAccess,IEquatable[object]):
 ...
 def __str__(self,*args):
  pass
 CommunicationGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ServerInterfaces=property(lambda self: object(),lambda self,v: None,lambda self: None)
