...
# Error generating skeleton for function GetService: Method must be called on a Type for which Type.IsGenericParameter is false.
 ...
 def __str__(self,*args):
  pass
 BlockGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ExternalSourceGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TagTableGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TechnologicalObjectGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TypeGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 WatchAndForceTableGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
