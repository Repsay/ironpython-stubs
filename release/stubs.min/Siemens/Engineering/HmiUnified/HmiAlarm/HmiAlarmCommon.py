...
class AlarmBase(HmiBase,IValidator,IEngineeringObject,IEngineeringCompositionOrObject,IEngineeringInstance,IInternalObjectAccess,IInternalInstanceAccess,IInternalBaseAccess,IEquatable[object]):
 ...
 def __str__(self,*args):
  pass
 AlarmClass=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 AlarmParameterTags=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 EventText=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 InfoText=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RaisedStateTag=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Flashing=property(lambda self: object(),lambda self,v: None,lambda self: None)
