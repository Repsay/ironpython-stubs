...
class HmiAlarmClass(HmiBase,IValidator,IEngineeringObject,IEngineeringCompositionOrObject,IEngineeringInstance,IInternalObjectAccess,IInternalInstanceAccess,IInternalBaseAccess,IEquatable[object]):
 ...
 def __str__(self,*args):
  pass
 AcknowledgedClearedState=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 AcknowledgedState=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ClearedState=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RaisedState=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StateMachine=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ConditionValue=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RaisedStateTagBitNumber=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TriggerMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
