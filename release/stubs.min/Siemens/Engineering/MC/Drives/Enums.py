...
class AbsoluteIncrementalFlag(Enum,IComparable,IFormattable,IConvertible):
 """
...
class DriveObjectActivationState(Enum,IComparable,IFormattable,IConvertible):
 """
...
class EncoderInterface(Enum,IComparable,IFormattable,IConvertible):
 """
...
class EncoderType(Enum,IComparable,IFormattable,IConvertible):
 """
...
class MotorType(Enum,IComparable,IFormattable,IConvertible):
 """
 Type of motor
...
class ResetMode(Enum,IComparable,IFormattable,IConvertible):
 """
...
class RotaryLinearFlag(Enum,IComparable,IFormattable,IConvertible):
 """
 AbsoluteIncrementalFlag of encoder
...
class TelegramType(Enum,IComparable,IFormattable,IConvertible):
 """
 Type of telegram
