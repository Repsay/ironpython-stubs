...
"""
    ...
    PcInterfaces = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    TargetInterfaces = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Gateways = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class ConnectionConfiguration(object, IEngineeringObject, IEngineeringCompositionOrObject, IEngineeringInstance, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    IsConfigured = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    Modes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
