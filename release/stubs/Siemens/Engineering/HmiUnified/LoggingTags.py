...
class HmiLoggingTag(object, IValidator, IEngineeringObject, IEngineeringCompositionOrObject, IEngineeringInstance, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    HighLimit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    LimitScope = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    LogConfiguration = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    LoggingMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Logging Mode
...
"""
    ...
    LowLimit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SmoothingDeltaValue = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SmoothingMaxTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Smoothing max time
...
"""
    ...
    SmoothingMinTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Smoothing min time
