...
class HmiSoftware(Software, IEngineeringObject, IEngineeringCompositionOrObject, IEngineeringInstance, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    AlarmClasses = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AlarmLogs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    AnalogAlarms = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DataLogs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    DiscreteAlarms = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    RuntimeSettings = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    SystemTags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
