...
class Sivarc(object, IEngineeringObject, IEngineeringCompositionOrObject, IEngineeringInstance, IEngineeringService, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    AlarmRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Alarm rules editor
...
"""
    ...
    CopyRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Copy rules editor
...
"""
    ...
    ScreenRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Screen rules editor
...
"""
    ...
    TagRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Tag rules editor
...
"""
    ...
    TextlistRules = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    IsGenerationSuccessful = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
