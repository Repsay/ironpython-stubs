...
"""
    ...
    ContentDescriptions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class MasterCopyContentDescription(object, IEngineeringObject, IEngineeringCompositionOrObject, IEngineeringInstance, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    ContentName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    MasterCopies = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Composition of MasterCopies
