...
class RHOnlineProvider(object, IEngineeringService, IInternalObjectAccess, IInternalInstanceAccess, IInternalBaseAccess, IEquatable[object]):
    ...
    BackupState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
"""
    ...
    PrimaryState = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
